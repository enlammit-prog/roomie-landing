...
const LABELS = {
  es: { switch: "EN", switchHref: "/concierge/en", cta: "Escribinos por WhatsApp" },
  en: { switch: "ES", switchHref: "/concierge", cta: "WhatsApp us" },
};

export default function ConciergeNav({ lang }: { lang: "es" | "en" }) {
  const l = LABELS[lang];
  return (
